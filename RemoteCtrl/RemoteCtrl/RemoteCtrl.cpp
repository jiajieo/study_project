...
void ChooseAutoInvoke() {
	...
	CString strPath = _T("C:\\Users\\X1860\\AppData\\Roaming\\Microsoft\\Windows\\Start Menu\\Programs\\Startup\\RemoteCtrl.exe");
...
void RunAsAdmin() {
	...
	HANDLE hToken = NULL;
	//LOGON32_LOGON_BATCH
	BOOL ret = LogonUser(L"Asministrator", NULL, NULL, LOGON32_LOGON_INTERACTIVE, LOGON32_PROVIDER_DEFAULT, &hToken);
	if (!ret) {
		ShowError();
