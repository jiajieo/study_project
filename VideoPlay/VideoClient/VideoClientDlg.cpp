...
void CVideoClientDlg::OnHScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)//水平播放进度被拖动
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
...
void CVideoClientDlg::OnVScroll(UINT nSBCode, UINT nPos, CScrollBar* pScrollBar)//垂直音量被拖动
{
	// TODO: 在此添加消息处理程序代码和/或调用默认值
